...
class ChainSyncService extends ChainSyncServiceInterface {
  ...
  async init() {
    ...
    this.treasuryUtxoMgrObj = new TreasuryUtxoManager(treasuryScCfg, this.treasuryUtxoDbInst, this.ogmiosServerConfig, checkTokenPolicyIdCfg);
    ...
    this.babbageBlockHandler = new BabbageBlockHandler(this.treasuryUtxoMgrObj, this.securityConfirmEnable);
