    ...
    */
    ...
    async getChainTip() {
        ...
        try {
            ...
            console.log("...getChainTip error...", e);
            return undefined;
        }
    }

    async getChainBlockHeight() {
        // console.log("\n\n .....getLatestBlock: ");
        // get query eraSummaries 
        try {
            let blockHeight = await this.queryClient.networkBlockHeight();
            // console.log("...getChainBlockHeight...", blockHeight);
            return blockHeight;

        } catch (e) {
            console.log("...getChainBlockHeight error...", e);
            return e;
        }
    }
